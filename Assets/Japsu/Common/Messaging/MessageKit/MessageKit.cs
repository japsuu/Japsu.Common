...
namespace Japsu.Common.MessageKit
{
    /// <summary>
    ...
    {
        private static Dictionary<int, List<Action>> _messageTable = new();
        ...
        public static void LogObservers(int messageType)
        {
            ...
            {
                UnityEngine.Debug.Log("MessageType: " + messageType + " has no observers");
                return;
            }
            ...
            for (int i = 0; i < _messageTable[messageType].Count; i++)
            {
    ...
    {
        private static Dictionary<int, List<Action<U>>> _messageTable = new();
    ...
    {
        private static Dictionary<int, List<Action<U, V>>> _messageTable = new();
