...
namespace Japsu.Common.MessageKit
{
    ...
    {
        private static Dictionary<int, List<MessageReceiver>> _messageTable = new();
    ...
    {
        private static Dictionary<int, List<MessageReceiver<U>>> _messageTable = new();
    ...
    {
        private static Dictionary<int, List<MessageReceiver<U, V>>> _messageTable = new();
