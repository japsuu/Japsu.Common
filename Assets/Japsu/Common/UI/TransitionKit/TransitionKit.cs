...
namespace Japsu.Common.TransitionKit
{
    public class TransitionKit : MonoBehaviour
    {
        ...
        public float deltaTime => useUnscaledDeltaTime ? Time.unscaledDeltaTime : Time.deltaTime;
        ...
        public static TransitionKit instance
        {
            get
            {
                if (!_instance)
                {
                    ...
                    if (!_instance)
                    {
                        GameObject obj = new("TransitionKit");
        ...
        private void initialize()
        {
            ...
            MeshFilter meshFilter = getOrAddComponent<MeshFilter>();
        ...
        {
            float halfHeight = 5f; // 5 is the camera.orthoSize which is the half height
        ...
        {
            Texture2D screenSnapshot = new(Screen.width, Screen.height, TextureFormat.RGB24, false, false);
